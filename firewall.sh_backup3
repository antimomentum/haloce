...
wait
ipset create LEGIT hash:ip timeout 20
...
iptables -t raw -A PREROUTING -i eth0 -p udp -m udp --dport 2302 --source-port 53 -j DROP
iptables -t raw -A PREROUTING -i eth0 -p udp -m udp --dport 2302 -m set --match-set LEGIT src -j SET --exist --add-set LEGIT src
iptables -t raw -A PREROUTING -i eth0 -p udp -m udp --dport 2302 -m set --match-set LEGIT src -j ACCEPT
iptables -t raw -A PREROUTING -i eth0 -p udp -m udp --dport 2302 -m set --match-set TEST1 src -j pcheck
iptables -t raw -A PREROUTING -i eth0 -p udp -m udp --dport 2302 -m set --match-set TESTS src -j ctest1
...
iptables -t raw -A PREROUTING -i eth0 -p udp -m udp --dport 2302 -j SET --add-set TEST1 src
...
iptables -t raw -A ctest1 -s 54.82.252.156 -j ACCEPT
iptables -t raw -A ctest1 -s 34.197.71.170 -j ACCEPT
iptables -t raw -A ctest1 -m set --match-set TEST1 src -j SET --exist --add-set TEST2 src
iptables -t raw -A ctest1 -j ACCEPT
iptables -t raw -A ctest2 -m set --match-set TEST1 src -m u32 --u32 "42=0x1333360c" -j ACCEPT
